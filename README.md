...
- [ x ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    React JS is a way of creating reusable UI components, allowing developers to create large web apps that can change data without reloading the page constantly. It solves the problem of handling data for faster response times smoothly.


- [ x ] What does it mean to _think_ in react?
    Thinking in React means to figure out the general look and flow of your components before committing any of it to code, basically thinking about how you're going to build out the applications and components in React before you start typing.


- [ x ] Describe state.
    State is an object that determines how a componenet renders and behaves--it's what allows you to create dynamic+interactive componenents.


- [ x ] Describe props.
    Props are components that can be customized when they are created, with different parameters. Props is short for properties.

- [ x ] What are side effects, and how do you sync effects in a React component to state or prop changes?
    A side effect is anything that results in changes that can be observed whwn a calculation is completed--that isn't the main calculation's results.
